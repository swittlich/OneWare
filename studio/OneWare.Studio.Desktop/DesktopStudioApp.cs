...
public class DesktopStudioApp : StudioApp
{
    ...
    {
        Container.Resolve<IPackageService>().RegisterPackageRepository("https://raw.githubusercontent.com/swittlich/OneWare.PublicPackages/main/oneware-packages.json");
